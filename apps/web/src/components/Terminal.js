...
const PromptInjectIcon = () => (_jsx("svg", { "aria-hidden": "true", className: "terminal-inject-icon", viewBox: "0 0 16 16", width: "14", height: "14", children: _jsx("path", { d: "M2 3h12v1H2V3Zm0 3h8v1H2V6Zm0 3h6v1H2V9Zm9 0l3 2.5L11 14v-5Z", fill: "currentColor" }) }));
export const Terminal = ({ terminalId, terminalLabel, layoutVersion, isSelected, initialPrompt, hidePromptPicker, onSelectTerminal, onAgentRuntimeStateChange, onTerminalRenamed, onTerminalActivity, }) => {
        ...
        const connect = () => {
            ...
            nextSocket.addEventListener("message", (event) => {
                ...
                try {
                    ...
                    if (payload.type === "rename" && typeof payload.coordinationName === "string") {
                        onTerminalRenamedRef.current?.(terminalId, payload.coordinationName);
                        return;
                    }
    ...
    return (_jsxs("div", { className: `terminal-pane${isSelected ? " terminal-pane--selected" : ""}`, "data-selected": isSelected ? "true" : "false", onFocusCapture: () => {
            onSelectTerminal?.(terminalId);
        }, onPointerDownCapture: () => {
            onSelectTerminal?.(terminalId);
        }, children: [_jsxs("div", { className: "terminal-header", "data-connection-state": connectionState, children: [_jsx("span", { className: "terminal-title", children: terminalTitle }), initialPrompt && !isPromptBannerDismissed && (_jsxs("div", { className: "terminal-prompt-banner", children: [_jsxs("button", { type: "button", className: "terminal-prompt-banner-inject", onClick: () => {
                                    const ws = socketRef.current;
                                    if (ws && ws.readyState === 1) {
                                        ws.send(JSON.stringify({ type: "input", data: initialPrompt }));
                                    }
                                    setIsPromptBannerDismissed(true);
                                }, title: initialPrompt, children: [_jsx(PromptInjectIcon, {}), _jsx("span", { className: "terminal-prompt-banner-text", children: initialPrompt.length > 60 ? `${initialPrompt.slice(0, 60)}...` : initialPrompt })] }), _jsx("button", { type: "button", className: "terminal-prompt-banner-close", "aria-label": "Dismiss prompt", onClick: () => {
                                    setIsPromptBannerDismissed(true);
                                }, children: _jsx(X, { size: 14 }) })] })), _jsxs("div", { className: "terminal-header-actions", children: [!hidePromptPicker && (_jsxs("div", { className: "terminal-prompt-picker-anchor", children: [_jsxs("button", { ref: promptPickerBtnRef, type: "button", className: "terminal-prompt-picker-btn", title: "Insert prompt", "aria-label": "Insert prompt", onClick: () => {
                                            setIsPromptPickerOpen((prev) => !prev);
                                        }, children: [_jsx(FileText, { size: 13 }), _jsx("span", { className: "terminal-prompt-picker-label", children: "Prompts" })] }), _jsx(TerminalPromptPicker, { isOpen: isPromptPickerOpen, anchorRef: promptPickerBtnRef, onClose: () => {
                                            setIsPromptPickerOpen(false);
                                        }, onSelectPrompt: handlePromptPickerSelect })] })), _jsx(AgentStateBadge, { state: agentState })] })] }), _jsx("div", { ref: containerRef, className: "terminal-mount", "data-testid": `terminal-${terminalId}`, "aria-label": `Terminal ${terminalId}` })] }));
};
