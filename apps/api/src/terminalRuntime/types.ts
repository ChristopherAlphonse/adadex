...
import { isTerminalAgentProvider, isTerminalCompletionSoundId } from "@adadex/core";
...
export type GitClientPullRequestSnapshot = Omit<
  CoordinationPullRequestSnapshot,
  "coordinationId" | "workspaceMode" | "status"
> & {
...
export type GitClient = {
  ...
  readWorktreeStatus(options: {
    cwd: string;
  }): Omit<CoordinationGitStatusSnapshot, "coordinationId" | "workspaceMode">;
